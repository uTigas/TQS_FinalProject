...
INSERT INTO USERS (username, password, name, role_role) VALUES ('user', '$2a$10$GiseHkdvwOFr7A9KRWbeiOmg/PYPhWVjdm42puLfOzR/gIAQrsAGy', 'User', 'USER') ON CONFLICT DO NOTHING;